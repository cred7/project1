          ...
          <ul className="flex items-center h-full">
            {home.map((l) => (
              <Link
                href={l.href}
                key={l.name}
                className="flex justify-center items-center h-full px-5 text-white hover:text-black hover:bg-white  nth-[1]:px-7 font-bold nth-[1]:bg-white nth-[1]:text-black nth-[1]:hover:text-white nth-[1]:hover:bg-[#002511] "
              >
                {l.name}
              </Link>
            ))}
